...
const NAV_ITEMS: { href: string; label: string; feature?: FeatureKey }[] = [
  { href: "/", label: "Home" }, { href: "/roster", label: "Roster" }, { href: "/schedule", label: "Schedule" },
